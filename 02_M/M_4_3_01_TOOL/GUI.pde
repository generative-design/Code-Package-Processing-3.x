...
void setupGUI(){
  ...
  infoBang.setColorLabel(color(50));
  infoBang.captionLabel().style().padding(4,3,3,3);
  infoBang.captionLabel().style().marginTop = -20;
  infoBang.captionLabel().style().marginLeft = 3;
  infoBang.captionLabel().style().marginRight = 5;
  infoBang.captionLabel().setColorBackground(0x99ffffff);
...
void controlEvent(ControlEvent theControlEvent) {
  ...
  if(theControlEvent.isController()) {
    if(theControlEvent.controller().name().equals("layerCount")) {
...
void attractorSmooth() {
  if (!guiEvent) {
    ...
    Toggle t = (Toggle) controlP5.controller("attractorTwirl");
...
void attractorTwirl() {
  if (!guiEvent) {
    ...
    Toggle t = (Toggle) controlP5.controller("attractorSmooth");
